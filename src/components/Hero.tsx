          ...
          <div className="space-y-4 sm:space-y-8">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl px-2 sm:px-4 py-3 sm:py-4 text-center min-h-[80px] sm:min-h-[100px]">
                ...
                <div className="text-lg sm:text-2xl font-bold text-foreground">Where numbers become melodies and 1,001 British Columbians share their AI perspectives through revolutionary music-powered analytics. Experience the breakthrough concept that transforms survey data into engaging musical stories by Vancouver AI community leaders.</div>
