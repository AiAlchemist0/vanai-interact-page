          ...
          <div className="space-y-8 lg:pr-8">
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row items-start gap-6">
                <img 
                  ...
                  className="w-32 h-auto filter drop-shadow-lg flex-shrink-0"
                />
                <div>
                  <h1 className="text-5xl lg:text-7xl font-bold text-gradient leading-tight mb-4">
                    BC AI Survey
                    <br />
                    Insights
                  </h1>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3">
                <Button 
                  size="lg" 
                  className="gradient-primary hover:glow-primary transition-smooth group flex-1" 
                ...
                <Button 
                  size="lg" 
                  className="gradient-secondary hover:glow-secondary transition-smooth group flex-1" 
              ...
              <Button 
                size="lg" 
                className="gradient-accent hover:glow-accent transition-smooth group w-full" 
