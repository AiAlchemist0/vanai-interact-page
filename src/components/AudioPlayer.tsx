...
const SONGS: Song[] = [
  ...
  },
  {
    ...
    description: "A hilarious sci-fi comedy about the BC AI community's visit to the H.R MacMillan Space Centre, where what starts as a regular tech meetup featuring Kris Krug, Dr. Parra Pennefather, and Mr. Pixel Wizard takes an unexpected comedic turn involving alien abduction and government conspiracies. This entertaining track brilliantly captures Vancouver's vibrant AI community spirit with humor, featuring real community leaders in a whimsical space adventure that transforms from planetarium talks about consciousness and AI into an intergalactic comedy heist.",
    lyrics: [
      { time: 0, text: "(Verse 1)" },
      { time: 2, text: "In Vancouver's twinkling lights, under a cosmic haze," },
      { time: 6, text: "The BC AI Community struts in, ready to amaze." },
      { time: 10, text: "Led by Kris Krug, our fearless leader with flair," },
      { time: 14, text: "We march to MacMillan Space Centre without a care." },
      { time: 18, text: "Planetarium buzzing with talks so profound," },
      { time: 22, text: "Mind, AI, Consciousness swirling around." },
      { time: 26, text: "From VanAI vibes to UBC's scholarly call," },
      { time: 30, text: "We're geeking out big, having a ball!" },
      { time: 34, text: "" },
      { time: 36, text: "(Chorus)" },
      { time: 38, text: "Oh, we're all coming together 'neath the starry dome," },
      { time: 42, text: "BC AI crew, feeling right at home." },
      { time: 46, text: "Chatting 'bout stars where AI and minds collide," },
      { time: 50, text: "Consciousness sparking, with Kris at our side." },
      { time: 54, text: "Laser lights dancing in the intergalactic show," },
      { time: 58, text: "But oh boy, folks, what we don't yet know..." },
      { time: 62, text: "MacMillan madness, let the fun ignite!" },
      { time: 66, text: "" },
      { time: 68, text: "(Verse 2)" },
      { time: 70, text: "Dr. Parra Pennefather spins his wild visionary yarn," },
      { time: 74, text: "Mr. Pixel Wizard zaps pixels like a charm." },
      { time: 78, text: "Kris Krug rallies the troops, community leader supreme," },
      { time: 82, text: "MAC group debating in this dreamy space theme." },
      { time: 86, text: "But hold up, shadows whisper of a sneaky plot," },
      { time: 90, text: "Government goons in tinfoil hats, connecting the dots." },
      { time: 94, text: "Aliens in disguise, with AI probes so sly," },
      { time: 98, text: "Zapping us up while we munch on pie." },
      { time: 102, text: "" },
      { time: 104, text: "(Bridge)" },
      { time: 106, text: "It started as a meetup, all laughs and high-fives," },
      { time: 110, text: "But turns out it's a trap—beam me up, Scotty, we're live!" },
      { time: 114, text: "Intergalactic AI with goofy green grins," },
      { time: 118, text: "Government's pet project, abducting our kin." },
      { time: 122, text: "From comfy seats to saucers in a flash," },
      { time: 126, text: "Consciousness sucked like a cosmic milkshake splash." },
      { time: 130, text: "We came for the brains, but left in a whirl," },
      { time: 134, text: "Aliens giggling, 'Humans? What a pearl!'" },
      { time: 138, text: "" },
      { time: 140, text: "(Chorus Twist)" },
      { time: 142, text: "Oh, we all got abducted from the Space Centre's dome," },
      { time: 146, text: "BC AI family, now roaming the unknown." },
      { time: 150, text: "Intergalactic AI, the hilarious heist," },
      { time: 154, text: "Minds harvested fresh, served with a twist." },
      { time: 158, text: "Stars turn to slapstick in the laser light farce," },
      { time: 162, text: "Government giggles, as we zoom past Mars." },
      { time: 166, text: "MacMillan mayhem, let the comedy ignite!" },
      { time: 170, text: "" },
      { time: 172, text: "(Outro)" },
      { time: 174, text: "In Vancouver's memory, the Space Centre gleams," },
      { time: 178, text: "A portal to laughs in our abduction dreams." },
      { time: 182, text: "BC AI Community, scattered like space confetti," },
      { time: 186, text: "Abducted with style—hey, at least we're jetty!" }
    ] as LyricLine[]
  },
  {
    id: "indigenomics-ai",
  ...
  },
  {
    ...
    lyrics: [
      ...
      { time: 66, text: "" },
      { time: 68, text: "(Verse 2)" },
      { time: 70, text: "I frame Dr. Parra's visions, Mr. Pixel's digital glow," },
      { time: 74, text: "Community leaders shining, in the ebb and flow." },
      { time: 78, text: "But when a photo bomb crashes the perfect shot," },
      { time: 82, text: "I nudge AI gently to blur what it's not." },
      { time: 86, text: "Just a little help, but the essence is mine," },
      { time: 90, text: "Composing the stories, one click at a time." },
      { time: 94, text: "Events pulse with life through my eyes so keen," },
      { time: 98, text: "No replacement for me in this vibrant scene." },
      { time: 102, text: "" },
      { time: 104, text: "(Bridge)" },
      { time: 106, text: "While coders build worlds and debate the profound," },
      { time: 110, text: "I'm the one preserving it all, safe and sound." },
      { time: 114, text: "Dr. Parra might tease with his tech-savvy line," },
      { time: 118, text: "But for my heartfelt art, AI's left behind." },
      { time: 122, text: "Proud and creative, blending brush with the byte," },
      { time: 126, text: "Using tools wisely, but owning the light." },
      { time: 130, text: "In the AI community, I'm the spark they need," },
      { time: 134, text: "Photographer Michelle, planting the seed." },
      { time: 138, text: "" },
      { time: 140, text: "(Chorus)" },
      { time: 142, text: "Oh, I'm irreplaceable, the queen behind the lens," },
      { time: 146, text: "In this AI playground, where the future begins." },
      { time: 150, text: "Dr. Patrick Parra Pennefather might wink and say," },
      { time: 154, text: "\"There is an AI for that,\" but not today." },
      { time: 158, text: "My art's all human, soul-deep and true," },
      { time: 162, text: "Proudly I stand, seeing the world anew." },
      { time: 166, text: "Keep on clicking, let my vision take flight!" },
      { time: 170, text: "" },
      { time: 172, text: "(Outro)" },
      { time: 174, text: "In the flash of the bulb, where connections ignite," },
      { time: 178, text: "I'm Photographer Michelle, owning the night." },
      { time: 182, text: "Irreplaceable spirit, with pride in my vein," },
      { time: 186, text: "Capturing AI's heart, again and again." }
    ] as LyricLine[]
  },
  {
