...
const SONGS: Song[] = [
  ...
  },
  {
    ...
    title: "Kris Krug Circles in the AI Glow",
    artist: "Kris Krüg",
    ...
    lyrics: [
      ...
      { time: 7, text: "Digital dreams in perfect trance" },
      { time: 10.5, text: "Bathed in artificial light" },
      { time: 14, text: "" },
      { time: 16, text: "Kris Krug leads the way" },
      { time: 19.5, text: "Through the luminescent maze" },
      { time: 23, text: "In the circles where we play" },
      { time: 26.5, text: "Lost in AI's endless gaze" },
      { time: 30, text: "" },
      { time: 32, text: "Circles in the AI glow" },
      { time: 35.5, text: "Round and round we go" },
      { time: 39, text: "In this electric flow" },
      { time: 42.5, text: "Nothing else we need to know" },
      { time: 46, text: "" },
      { time: 48, text: "Neural networks pulse and beam" },
      { time: 51.5, text: "Creating patterns in the air" },
      { time: 55, text: "Living in this digital dream" },
      { time: 58.5, text: "Circling without a care" }
    ] as LyricLine[]
  },
  {
    id: "pixel-wizard",
