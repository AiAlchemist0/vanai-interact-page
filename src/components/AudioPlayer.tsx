...
const SONGS = [
  {
    ...
    src: "https://www.soundjay.com/misc/sounds/bell-ringing-05.mp3", // Demo placeholder
    coverArt: hrMacMillanCover,
    lyrics: [
      { time: 0, text: "🎵 This is a demo version 🎵" },
      { time: 4, text: "Upload the actual MP3 files to public directory" },
      { time: 8, text: "to hear the full audio content" },
      { time: 12, text: "Original track: Alien Abduction" },
      { time: 16, text: "" },
      { time: 18, text: "Under the dome of starlit night" },
      { time: 22, text: "The MacMillan Centre stands tall" },
      { time: 26, text: "Cosmic mysteries come to light" },
      { time: 30, text: "As alien visitors call" }
    ] as LyricLine[]
  },
  {
    id: "bc-ai-hackathon",
    ...
    lyrics: [
      ...
      { time: 4, text: "Upload the actual MP3 files to public directory" },
      { time: 8, text: "to hear the full audio content" },
      { time: 12, text: "Original track: BC AI Hackathon" },
      { time: 16, text: "" },
      { time: 18, text: "Code flows through the digital night" },
      { time: 22, text: "BC AI hackathon has begun" },
      { time: 26, text: "Rival Tech brings innovation bright" },
      { time: 30, text: "Building futures, one by one" }
    ] as LyricLine[]
  },
  {
    id: "mac",
    ...
    lyrics: [
      ...
      { time: 4, text: "Upload the actual MP3 files to public directory" },
      { time: 8, text: "to hear the full audio content" },
      { time: 12, text: "Original track: Mind, AI, & Consciousness" },
      { time: 16, text: "" },
      { time: 18, text: "What is consciousness in the age of AI?" },
      { time: 22, text: "Questions that keep us awake at night" },
      { time: 26, text: "Mind and machine begin to tie" },
      { time: 30, text: "The future burning ever bright" }
    ] as LyricLine[]
  },
  {
    id: "deepfakes",
    ...
    lyrics: [
      ...
      { time: 4, text: "Upload the actual MP3 files to public directory" },
      { time: 8, text: "to hear the full audio content" },
      { time: 12, text: "Original track: Deepfakes in the Rain" },
      { time: 16, text: "" },
      { time: 18, text: "In the digital rain we fall" },
      { time: 22, text: "Where reality bends and breaks" },
      { time: 26, text: "Synthetic faces on the wall" },
      { time: 30, text: "Nothing here is what it takes" }
    ] as LyricLine[]
  },
  {
    id: "pixel-wizard",
    ...
    lyrics: [
      ...
      { time: 4, text: "Upload the actual MP3 files to public directory" },
      { time: 8, text: "to hear the full audio content" },
      { time: 12, text: "Original track: Mr. Pixel Wizard BC AI" },
      { time: 16, text: "" },
      { time: 18, text: "In the realm of digital art" },
      { time: 22, text: "Mr. Pixel Wizard stands" },
      { time: 26, text: "Creating magic, bit by part" },
      { time: 30, text: "With his algorithmic hands" }
    ] as LyricLine[]
  },
  {
    id: "dr-patrick",
    ...
    lyrics: [
      ...
      { time: 4, text: "Upload the actual MP3 files to public directory" },
      { time: 8, text: "to hear the full audio content" },
      { time: 12, text: "Original track: Dr. Patrick Parra Pennefather" },
      { time: 16, text: "" },
      { time: 18, text: "In the halls of learning high" },
      { time: 22, text: "Dr. Patrick leads the way" },
      { time: 26, text: "With his wisdom reaching sky" },
      { time: 30, text: "Teaching truth both night and day" }
    ] as LyricLine[]
  }
];
