...
export const SONGS: Song[] = [
  {
    ...
    lyrics: [
      ...
      { time: 40, text: "Machine learning models train day and night," },
      { time: 44, text: "Neural networks processing with all their might." },
      { time: 48, text: "Data scientists crafting insights so profound," },
      { time: 52, text: "While entrepreneurs pitch ideas that astound." },
      { time: 56, text: "From cloud computing to edge device tech," },
      { time: 60, text: "We're building the future, what the heck!" },
      { time: 64, text: "Collaboration flows like the Fraser River wide," },
      { time: 68, text: "BC AI community stands with pride." },
      { time: 72, text: "Innovation, collaboration, transformation true," },
      { time: 76, text: "BC AI Hackathon, we believe in you!" },
    ] as LyricLine[]
  },
  {
    ...
    description: `Lionel Ringenbach's "ChatGPT: Est-ce que ma facture va exploser?" addresses critical questions around AI's environmental and economic impact - themes central to the BC + AI Survey's exploration of technology's broader implications. Through his song, Lionel examines the hidden costs of AI systems, from energy consumption to infrastructure demands.<br/><br/>As founder of <a href="https://wattsup.tech" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">wattsup.tech</a>, Lionel brings technical expertise to the sustainability conversation, making this song both a creative expression and an important commentary on responsible AI development. His bilingual approach reflects Quebec's unique position in Canada's AI landscape, bridging European sustainability perspectives with North American innovation culture.`,
    lyrics: [
      { time: 0, text: "(Verse 1)" },
      ...
      { time: 42, text: "(Chorus)" },
      { time: 44, text: "ChatGPT, ChatGPT, what's the price we pay?" },
      { time: 48, text: "For every query, every single day?" },
      { time: 52, text: "Les watts qui montent, the energy flowing," },
      { time: 56, text: "Is sustainability really growing?" },
      { time: 60, text: "(Verse 2)" },
      { time: 62, text: "Data centers humming across the land," },
      { time: 66, text: "Cooling systems working, supply and demand." },
      { time: 70, text: "Green computing, c'est l'avenir," },
      { time: 74, text: "Mais maintenant, que faut-il choisir?" },
      { time: 78, text: "Between progress and our planet's health," },
      { time: 82, text: "Between AI magic and sustainable wealth." },
      { time: 86, text: "The future depends on choices we make," },
      { time: 90, text: "For our children's and our planet's sake." },
    ] as LyricLine[]
  },
  {
  ...
  },
  {
    ...
    description: `Kevin Friel's "Mr. Pixel Wizard BC AI" celebrates Vancouver's AI filmmaking community and the transformative power of AI in creative industries. The song highlights how AI tools are democratizing film production, breaking down traditional barriers, and enabling artists to create without massive budgets or crews.<br/><br/>Kevin, known in the Vancouver creative scene as both filmmaker and AI enthusiast, specifically honors the VanAI community's role in fostering innovation and collaboration among AI enthusiasts and creators in British Columbia. His work represents the intersection of traditional storytelling craft with cutting-edge AI tools, showing how technology can amplify human creativity rather than replace it.`,
    lyrics: [
      { time: 0, text: "(Verse 1)" },
      ...
      { time: 35, text: "(Chorus)" },
      { time: 37, text: "Pixel wizard, weaving stories bright," },
      { time: 41, text: "AI and human creativity in flight." },
      { time: 45, text: "From concept to screen, the magic flows," },
      { time: 49, text: "In British Columbia, where innovation grows." },
      { time: 53, text: "(Verse 2)" },
      { time: 55, text: "Frame by frame, the vision builds," },
      { time: 59, text: "Digital landscapes, creative guilds." },
      { time: 63, text: "Vancouver's spirit, tech and art combined," },
      { time: 67, text: "The future of film, creatively designed." },
      { time: 71, text: "Independent voices, breaking through," },
      { time: 75, text: "AI empowering, me and you." },
      { time: 79, text: "No studio gates can hold us back," },
      { time: 83, text: "When pixel wizards lead the pack." },
    ] as LyricLine[]
  },
  {
    id: "dr-patrick",
