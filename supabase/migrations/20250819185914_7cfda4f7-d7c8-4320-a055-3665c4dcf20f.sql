-- Update the get_dashboard_stats function to count all available songs instead of just played songs
...
BEGIN
  ...
  SELECT 
    ...
    -- Count all available songs in the catalog (17 total) instead of just played songs
    17::bigint as unique_songs,
