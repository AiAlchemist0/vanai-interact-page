...
('circles-in-the-ai-glow', 'machine cold glow', 'AI Experience', 7),
...
('circles-in-the-ai-glow', 'humanity vibe', 'Identity', 9),
('circles-in-the-ai-glow', 'real or just pixels', 'Identity', 8),
('circles-in-the-ai-glow', 'humanity the start', 'Identity', 8),
